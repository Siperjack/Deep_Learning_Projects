...
epochs = 2
#%% Loading
AE_MONO_BINARY_COMPLETE = AE(trained = trained, filename = "./models/MONO_BINARY_COMPLETE")
...
AE_MONO_BINARY_MISSING = AE(trained = trained, filename = "./models/MONO_BINARY_MISSING")
